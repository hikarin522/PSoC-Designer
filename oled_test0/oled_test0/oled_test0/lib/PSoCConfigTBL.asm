...
export LoadConfigTBL_oled_test0_Bank1
export LoadConfigTBL_oled_test0_Bank0
export LoadConfigTBL_oled_test0_Ordered
AREA lit(rom, rel)
LoadConfigTBL_oled_test0_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_oled_test0_Bank1:
;  Instance name LCD_1, User Module LCD
...
LoadConfigTBL_oled_test0_Ordered:
