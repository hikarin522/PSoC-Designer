...
export LoadConfigTBL_matrix_led_v1_Bank1
export LoadConfigTBL_matrix_led_v1_Bank0
export LoadConfigTBL_matrix_led_v1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_matrix_led_v1_Bank0:
...
;       Instance name Timer8_1, Block Name TIMER8(DBB00)
	...
	db		21h, 1fh		;Timer8_1_PERIOD_REG(DBB00DR1)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_matrix_led_v1_Bank1:
;  Instance name SHADOWREGS_1, User Module SHADOWREGS
;  Instance name SleepTimer_1, User Module SleepTimer
;  Instance name Timer8_1, User Module Timer8
;       Instance name Timer8_1, Block Name TIMER8(DBB00)
...
LoadConfigTBL_matrix_led_v1_Ordered:
