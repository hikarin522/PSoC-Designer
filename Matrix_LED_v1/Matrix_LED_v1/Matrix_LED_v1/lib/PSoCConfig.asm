...
export LoadConfig_matrix_led_v1
export _LoadConfig_matrix_led_v1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_matrix_led_v1
	lcall	LoadConfigTBL_matrix_led_v1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration matrix_led_v1
;
;    Load configuration registers for matrix_led_v1.
...
;               CUR_PP
;
_LoadConfig_matrix_led_v1:
 LoadConfig_matrix_led_v1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_matrix_led_v1_Bank0
    mov     X, <LoadConfigTBL_matrix_led_v1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_matrix_led_v1_Bank1
    mov     X, <LoadConfigTBL_matrix_led_v1_Bank1
