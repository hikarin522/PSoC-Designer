...
export LoadConfigTBL_matrixled_test0_Bank1
export LoadConfigTBL_matrixled_test0_Bank0
export LoadConfigTBL_matrixled_test0_Ordered
AREA lit(rom, rel)
LoadConfigTBL_matrixled_test0_Bank0:
...
;       Instance name Timer8_1, Block Name TIMER8(DBB00)
	...
	db		21h, 0fh		;Timer8_1_PERIOD_REG(DBB00DR1)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_matrixled_test0_Bank1:
;  Instance name SleepTimer_1, User Module SleepTimer
;  Instance name Timer8_1, User Module Timer8
;       Instance name Timer8_1, Block Name TIMER8(DBB00)
	db		20h, 30h		;Timer8_1_FUNC_REG(DBB00FN)
	db		21h, 07h		;Timer8_1_INPUT_REG(DBB00IN)
...
LoadConfigTBL_matrixled_test0_Ordered:
