...
;  Global Symbols
;-----------------------------------------------
export   DigInv_1_EnableInt
export  _DigInv_1_EnableInt
export   DigInv_1_DisableInt
export  _DigInv_1_DisableInt
export   DigInv_1_Start
export  _DigInv_1_Start
export   DigInv_1_Stop
export  _DigInv_1_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DigInv_1_EnableInt
;
;  DESCRIPTION:
...
_DigInv_1_EnableInt:
   ...
   M8C_EnableIntMask DigInv_1_INT_REG, DigInv_1_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DigInv_1_DisableInt
;
;  DESCRIPTION:
...
;
 DigInv_1_DisableInt:
_DigInv_1_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask DigInv_1_INT_REG, DigInv_1_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_DigInv_1_Start:
   ...
   mov   A, REG[DigInv_1_OUTPUT_REG]
   push  A

   mov   REG[DigInv_1_OUTPUT_REG], 0

   ; set the input to the 48MHz clock
   mov   A, REG[DigInv_1_INPUT_REG]
   push  A

   mov   REG[DigInv_1_INPUT_REG], 04

   M8C_SetBank0
   ; start the inverter
   or    REG[DigInv_1_CONTROL_REG], bfCONTROL_REG_START_BIT

   ; Re-instate the input
   M8C_SetBank1
   pop   A
   mov   REG[DigInv_1_INPUT_REG], A

   ; Re-instate the output
   pop   A
   mov   REG[DigInv_1_OUTPUT_REG], A
   M8C_SetBank0

   ;clear interrupt
   M8C_ClearIntFlag INT_CLR1, DigInv_1_bINT_MASK

   ; Re-instate the interrupt state
   pop   A
   mov   REG[DigInv_1_INT_REG], A
...
_DigInv_1_Stop:
   ...
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[DigInv_1_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File DigInv_1.asm
