...
export LoadConfigTBL_line_test0_Bank1
export LoadConfigTBL_line_test0_Bank0
export LoadConfigTBL_line_test0_Ordered
AREA lit(rom, rel)
LoadConfigTBL_line_test0_Bank0:
;  Instance name CLK, User Module LED
;  Instance name LCD_1, User Module LCD
;  Instance name SAR6_1, User Module SAR6
;       Instance name SAR6_1, Block Name SA(ASC10)
	db		80h, 00h		;SAR6_1_CR0(ASC10CR0)
	db		81h, 5fh		;SAR6_1_CR1(ASC10CR1)
	db		82h, 60h		;SAR6_1_CR2(ASC10CR2)
	db		83h, 08h		;SAR6_1_CR3(ASC10CR3)
;  Instance name SI, User Module LED
;  Instance name SleepTimer_1, User Module SleepTimer
;  Instance name TX8_1, User Module TX8
;       Instance name TX8_1, Block Name TX8(DCB02)
	db		2bh, 00h		;TX8_1_CONTROL_REG  (DCB02CR0)
	db		29h, 00h		;TX8_1_TX_BUFFER_REG(DCB02DR1)
	db		2ah, 00h		;TX8_1_(DCB02DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_line_test0_Bank1:
;  Instance name CLK, User Module LED
;  Instance name LCD_1, User Module LCD
;  Instance name SAR6_1, User Module SAR6
;       Instance name SAR6_1, Block Name SA(ASC10)
...
;  Instance name TX8_1, User Module TX8
;       Instance name TX8_1, Block Name TX8(DCB02)
	db		28h, 0dh		;TX8_1_FUNC_REG     (DCB02FN)
	db		29h, 01h		;TX8_1_INPUT_REG    (DCB02IN)
	db		2ah, 47h		;TX8_1_OUTPUT_REG   (DCB02OU)
;  Global Register values Bank 1
	...
	db		e1h, 44h		; OscillatorControl_1 register (OSC_CR1)
	db		e2h, 00h		; OscillatorControl_2 register (OSC_CR2)
	db		dfh, 3eh		; OscillatorControl_3 register (OSC_CR3)
...
LoadConfigTBL_line_test0_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[07h], 54h		; Port_1_DriveMode_2 register (PRT1DM2)
