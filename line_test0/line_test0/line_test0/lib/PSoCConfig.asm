...
export LoadConfig_line_test0
export _LoadConfig_line_test0
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_line_test0
	lcall	LoadConfigTBL_line_test0_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration line_test0
;
;    Load configuration registers for line_test0.
...
;               CUR_PP
;
_LoadConfig_line_test0:
 LoadConfig_line_test0:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_line_test0_Bank0
    mov     X, <LoadConfigTBL_line_test0_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_line_test0_Bank1
    mov     X, <LoadConfigTBL_line_test0_Bank1
