...
export LoadConfigTBL_asm_test0_Bank1
export LoadConfigTBL_asm_test0_Bank0
export LoadConfigTBL_asm_test0_Ordered
AREA lit(rom, rel)
LoadConfigTBL_asm_test0_Bank0:
...
LoadConfigTBL_asm_test0_Ordered:
