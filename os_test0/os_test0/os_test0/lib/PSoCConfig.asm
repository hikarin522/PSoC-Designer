...
export LoadConfig_os_test0
export _LoadConfig_os_test0
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_os_test0
	lcall	LoadConfigTBL_os_test0_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration os_test0
;
;    Load configuration registers for os_test0.
...
_LoadConfig_os_test0:
 LoadConfig_os_test0:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_os_test0_Bank0
    mov     X, <LoadConfigTBL_os_test0_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_os_test0_Bank1
    mov     X, <LoadConfigTBL_os_test0_Bank1
